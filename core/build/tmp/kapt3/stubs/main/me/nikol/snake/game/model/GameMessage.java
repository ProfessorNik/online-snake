...
public final class GameMessage<T extends java.lang.Object> {
    ...
    public final me.nikol.snake.game.model.GameMessage<T> copy(@com.fasterxml.jackson.annotation.JsonProperty(value = "msg_seq")
    long msgSeq, @org.jetbrains.annotations.Nullable
    @com.fasterxml.jackson.annotation.JsonProperty(value = "sender_id")
    java.lang.Integer senderId, @org.jetbrains.annotations.Nullable
    @com.fasterxml.jackson.annotation.JsonProperty(value = "receiver_id")
    ...
    public GameMessage(@com.fasterxml.jackson.annotation.JsonProperty(value = "msg_seq")
    long msgSeq, @org.jetbrains.annotations.Nullable
    @com.fasterxml.jackson.annotation.JsonProperty(value = "sender_id")
    java.lang.Integer senderId, @org.jetbrains.annotations.Nullable
    @com.fasterxml.jackson.annotation.JsonProperty(value = "receiver_id")
